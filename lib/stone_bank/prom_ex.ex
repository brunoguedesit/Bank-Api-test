defmodule StoneBank.PromEx do
  ...
  1. Update your configuration (config.exs, dev.exs, prod.exs, releases.exs, etc) to
     ...
     ```
     config :stone_bank, StoneBank.PromEx,
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule StoneBankWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :stone_bank

       ...

       plug PromEx.Plug, prom_ex_module: StoneBank.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      # {Plugins.Phoenix, router: StoneBankWeb.Router},
      Plugins.Ecto,
      Plugins.PhoenixLiveView
      # Plugins.Oban

      # Add your own PromEx metrics plugins
      # StoneBank.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:stone_bank, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
